        ...
        <div class="row">
            <div class="col-md-auto mb-3">
                <div class="btn-submit">
                    <a class="button" href="addSchool.php">Add</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="tableProduct">
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%;">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $school = mysqli_query($conn, "SELECT * FROM school ORDER BY id ");
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="button-table" href="editSchool.php?ids=<?php echo $row['id'] ?>"><i class='bx bxs-edit-alt me-1'></i>Edit</a>
                                            <a class="button-table" id="delete" href="../include/delete.php?ids=<?php echo $row['id'] ?>"><i class='bx bxs-trash me-1'></i>Delete</a>
                                        </td>
                                    </tr>
                                <?php }
                            } else { ?>
