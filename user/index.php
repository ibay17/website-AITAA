...
<section id="alumniProfile">
    <div class="container">
        ...
        <div class="row text-center justify-content-center mt-5" style="margin-top: 75px !important;">
            <div class="col-md-12 mt-5">
                <a href="changePassword.php" class="btn-submit px-3 py-2" style="margin-bottom: 20px !important;">Change password</a>
                <a href="updateInfo.php" class="px-3 py-2"><button class="btn-submit mt-3" style="border:none;">Update contact information</button></a>
            </div>
        </div>
    </div>
    <?php
    ...
    <div class="container text-center">
        <div class="row align-items-center">
            <div class="col-md-12 d-flex justify-content-end">
                <a href="../auth/logout.php" class="btn-submit px-3 py-2">Log Out</a>
